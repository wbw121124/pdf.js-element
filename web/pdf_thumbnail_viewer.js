...
class PDFThumbnailViewer {
    ...
    this.container.addEventListener("keydown", e => {
      switch (e.key) {
        ...
        case "ArrowUp":
          ...
          break;
        case "Home":
          this.#focusThumbnailElement(this._thumbnails[0]);
          stopEvent(e);
          break;
        case "End":
          this.#focusThumbnailElement(this._thumbnails.at(-1));
          stopEvent(e);
          break;
        case "Enter":
        case " ":
  ...
  /**
   * Focus the image of a thumbnail.
   * @param {PDFThumbnailView} thumbnail
   */
  #focusThumbnailElement(thumbnail) {
    if (thumbnail) {
  ...
  #goToNextItem(element, forward, horizontal) {
    ...
    if (nextThumbnail) {
      this.#focusThumbnailElement(nextThumbnail);
    }
  }
}
